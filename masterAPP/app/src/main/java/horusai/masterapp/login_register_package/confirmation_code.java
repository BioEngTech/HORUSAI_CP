...
public class confirmation_code extends AppCompatActivity implements View.OnClickListener,View.OnFocusChangeListener{
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.confirmation_layout_continue_btn) {
            ...
            Intent registerIntent = new Intent(confirmation_code.this,register.class);
            ...
            Intent phoneIntent = new Intent(confirmation_code.this,telephone.class);
