...
public class HomeAuthSliderAdapter extends PagerAdapter{
    ...
    public HomeAuthSliderAdapter(Activity context, ArrayList<Drawable> images, ArrayList<String> descriptions,ArrayList<Integer> sizes){
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int pos) {
        ...
        View view = layoutInflater.inflate(R.layout.authentication_home_view, container, false);
